    ...
    def __init__(self):
        ...
        self._sprite_definitions = {
            Entity.TypeArea.PLAYER: {
                'positions': [(10, 230, 90, 90), (10, 200, 100, 150)],  # Player sprites where we found green pixels
                'size': (16, 10)
            },
            Entity.TypeArea.ENEMY: {
                'positions': [(40, 40, 16, 16), (60, 40, 16, 16), (80, 40, 16, 16),  # birds
                             (40, 60, 16, 16), (60, 60, 16, 16), (80, 60, 16, 16)],   # bats
                'size': (16, 16)
            },
